...
# set_property PACKAGE_PIN AA11 [get_ports {JA2}];  # "JA2"
 set_property PACKAGE_PIN Y10  [get_ports {sda}];  # "JA3"
 set_property PACKAGE_PIN AA9  [get_ports {scl}];  # "JA4"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
 set_property PACKAGE_PIN T22 [get_ports {err}];  # "LD0"
 set_property PACKAGE_PIN T21 [get_ports {valid}];  # "LD1"
